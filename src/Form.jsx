    ...
    <main className="bg-white p-6 sm:p-8 rounded-xl shadow-xl w-full max-w-lg border border-gray-100">
        ...
        <form action="" className="space-y-5">
                ...
                <div className='relative'>
                    ...
                    <User size={22} className='text-gray-700  absolute top-1/2 -translate-y-1/2 left-1.5' />
            ...
            <div className="grid grid-cols-1 relative ">
                ...
                <LockKeyhole size={22} className='text-gray-700  absolute top-1/2 -translate-y-1/2 left-1.5'/>
